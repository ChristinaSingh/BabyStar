...
class CommonWidgets {
    ...
    return AppBar(
      ...
      leading: wantBackButton
          ? GestureDetector(
              ...
              child: Center(
                child: appIcons(
                  assetName: showColorBackButton
                      ? IconConstants.icCircleBack
  ...
  static Widget dataNotFound({String? text}) {
    return Column(
      children: [
        Image.asset(ImageConstants.imgDataNotFound),
        Text(
          text ?? '',
          style: MyTextStyle.titleStyle20bb,
        )
  ...
  static void showErrorGetSnackBar({
          ...
          Container(
            ...
            decoration: decoration ??
                BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(borderRadius ?? 14.px),
                    border: Border.all(
                        color: isCard ? primaryColor : const Color(0xFFF5F5F5),
                        width: 1.px)),
            child: Padding(
              padding:
